-- Fix equipment_details view to properly join with equipment_company table
...
LEFT JOIN equipment_company eqc ON e.owner_id = eqc.id  -- Join on equipment_company.id (integer)
