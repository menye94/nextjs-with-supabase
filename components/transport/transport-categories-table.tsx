...
interface TransportCategoriesTableProps {
  searchQuery?: string;
  onSearchChange?: (query: string) => void;
}

export default function TransportCategoriesTable({ searchQuery = '', onSearchChange }: TransportCategoriesTableProps) {
  ...
  const handleEdit = (category: TransportCategory) => {
  ...
  const filteredCategories = categories.filter(category => {
    ...
    const matchesCompany = !filterCompany || category.owner_id === filterCompany;
  ...
  const columns = [
    {
      key: 'name',
      label: 'Name',
      render: (value: any, row: TransportCategory) => (
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <h2 className="text-2xl font-bold text-gray-900">Transport Categories</h2>
